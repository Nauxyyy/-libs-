...
modo = Group("modo", "helper")
admin = Group("admin", "modo")
resp = Group("resp", "admin")
_dev = Group("_dev", "resp")
fonda = Group("fonda", "_dev")
superadmin = Group("superadmin", "fonda")

-- ACL
ExecuteCommand('add_principal group.helper group.user')
ExecuteCommand('add_principal group.modo group.helper')
ExecuteCommand('add_principal group.admin group.modo')
ExecuteCommand('add_principal group.resp group.admin')
ExecuteCommand('add_principal group._dev group.resp')
ExecuteCommand('add_principal group.fonda group._dev')
ExecuteCommand('add_principal group.superadmin group.fonda')
